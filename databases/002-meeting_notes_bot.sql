...
CREATE TABLE `chat_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `meeting_id_idx` (`meeting_id`) /*!80000 INVISIBLE */,
  KEY `notes_idx` (`meeting_id`,`notes_version`),
  CONSTRAINT `meeting_id_2` FOREIGN KEY (`meeting_id`) REFERENCES `meetings` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `notes` FOREIGN KEY (`meeting_id`, `notes_version`) REFERENCES `notes` (`meeting_id`, `version`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci